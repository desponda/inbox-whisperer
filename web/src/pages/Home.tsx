...
const InboxIcon = () => (
  <svg width="160" height="160" viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      ...
      <linearGradient id="icon-gradient" x1="0" y1="0" x2="160" y2="160" gradientUnits="userSpaceOnUse">
        <stop stopColor="#14e0c9" />
        <stop offset="1" stopColor="#00b4d8" />
      </linearGradient>
    </defs>
    <circle cx="80" cy="80" r="78" fill="url(#glow)" />
    <rect x="30" y="50" width="100" height="60" rx="16" fill="#202e3a" stroke="url(#icon-gradient)" strokeWidth="4" />
    <polyline points="40,60 80,95 120,60" fill="none" stroke="url(#icon-gradient)" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
    ...
    <section className="flex-1 flex flex-col items-center justify-center px-4 z-10 relative">
      ...
      <div className="w-full max-w-2xl flex flex-col items-center justify-center text-center py-20">
        ...
        <h1 className="text-5xl md:text-6xl font-black mb-4 tracking-tight leading-tight">
          ...
          <span className="bg-gradient-to-r from-cyan-400 via-blue-400 to-accent bg-clip-text text-transparent" style={{ WebkitTextStroke: '0.5px #14e0c9' }}>Inbox</span>
        </h1>
        {/* Subheadline */}
        <p className="mb-8 text-lg md:text-xl text-gray-300 font-medium">
          Meet Inbox Whisperer, the <span className="font-bold text-accent">AI-powered</span> inbox assistant<br className="hidden md:inline" /> that maximizes your productivity and privacy.
        </p>
        {/* CTA Button */}
      ...
      <div className="w-full max-w-4xl mx-auto mt-10 flex items-center justify-center">
        <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-800 bg-[#181f2a] bg-opacity-90 p-2 flex items-center justify-center min-h-[200px] min-w-[320px]">
          ...
          <span className="text-gray-500 text-lg">[ App screenshot or illustration coming soon ]</span>
        </div>
      </div>
    </section>
    {/* FOOTER */}
